    ...
    private fun makeUpdate(tx: WireTransaction, netDelta: Vault.Update, ourKeys: Set<PublicKey>): Vault.Update {
        ...
        val consumedStates =
            if (consumedRefs.isNotEmpty()) {
                ...
                // a new collection and instead contains() just checks the contains() of both parameters
                val unconsumedStates = states(stateType, EnumSet.of(Vault.StateStatus.UNCONSUMED))
